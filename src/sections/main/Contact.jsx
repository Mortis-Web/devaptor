      ...
      <div className="relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden">
        <figure className="absolute top-0 -left-20 hidden h-full w-72 overflow-hidden sm:block lg:left-20 lg:w-96">
          ...
          <ImageClipBox
            ...
            clipClass="contact-clip-path-2 translate-y-7/10  lg:translate-y-40 md:translate-y-60"
          />
        </figure>
        <figure className="absolute -top-42 right-0 left-0 mx-auto w-60 sm:top-1/2 sm:left-[initial] md:right-10 md:left-auto lg:top-20 lg:w-80">
          <ImageClipBox
        ...
        <article className="pointer-events-none -mb-10 flex flex-col items-center text-center sm:mb-0">
          <AnimatedTitle
            ...
            containerClass={
              'special-font mt-10 w-full text-5xl leading-[0.9] mix-blend-difference md:text-[6rem]'
            }
            isInView={isInView}
          />
        </article>
        <Btn
          title="Contact Us"
          containerClass={`mt-10 ${isInView ? 'textAnimSlowest' : ''} mx-auto block bg-violet-50`}
        />
      </div>
    </section>
  );
